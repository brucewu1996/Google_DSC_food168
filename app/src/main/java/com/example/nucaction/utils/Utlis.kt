package com.example.nucaction.utils
...
import com.example.nucaction.camera.CameraSizePair
...
object Utils {
    ...
    fun generateValidPreviewSizeList(camera: Camera): List<CameraSizePair> {
        ...
        // the preview sizes and hope that the NucAction.camera can handle it.  Probably unlikely, but we still
        // account for it.
