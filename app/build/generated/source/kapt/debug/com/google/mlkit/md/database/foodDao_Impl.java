...
public final class foodDao_Impl implements foodDao {
  ...
  public foodDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOffood = new EntityInsertionAdapter<food>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `food` (`id`,`item`,`energy`,`protein`,`total_lipid`,`carbohydrate`,`fiber`,`sugar`,`Na`,`saturated_fatty_acids`,`trans_fatty_acids`,`cholesterol`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, food value) {
        ...
        stmt.bindDouble(3, value.getEnergy());
        stmt.bindDouble(4, value.getProtein());
        stmt.bindDouble(5, value.getTotal_lipid());
        stmt.bindDouble(6, value.getCarbohydrate());
        stmt.bindDouble(7, value.getFiber());
        stmt.bindDouble(8, value.getSugar());
        stmt.bindDouble(9, value.getNa());
        stmt.bindDouble(10, value.getSaturated_fatty_acids());
        stmt.bindDouble(11, value.getTrans_fatty_acids());
        stmt.bindDouble(12, value.getCholesterol());
      }
    };
  ...
  @Override
  public void insertAll(final List<food> food) {
  ...
  @Override
  public Object insert(final food food, final Continuation<? super Unit> p1) {
  ...
  @Override
  public food finditembyfood(final String food_input) {
    final String _sql = "SELECT * FROM food WHERE item = ? LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (food_input == null) {
      _statement.bindNull(_argIndex);
    } else {
      _statement.bindString(_argIndex, food_input);
    }
    __db.assertNotSuspendingTransaction();
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        _result = new food(_tmpId,_tmpItem,_tmpEnergy,_tmpProtein,_tmpTotal_lipid,_tmpCarbohydrate,_tmpFiber,_tmpSugar,_tmpNa,_tmpSaturated_fatty_acids,_tmpTrans_fatty_acids,_tmpCholesterol);
      } else {
        _result = null;
      }
      return _result;
